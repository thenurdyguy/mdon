...
/* Imports */ import fs from 'fs'; import path from 'path'; const module = { filename: 'mdon/lib/index.mjs' };
...
/* Exports */ export { mdon, Package, Compiler, Context, Macro }; export default mdon;
